...
void Vertex::post_update()
{
    ...
    /// Reprendre la valeur du slider dans la donnée m_value locale  /// GERE LA POPULATION DE L'INDIVIDU
...
/*void Save_Graph(std::string fich)
{
    std::ofstream fichier(fich, std::ios::out);  // ouverture en écriture avec effacement du fichier ouvert

        if(fichier)
        {
            std::string nom = "Xav57";
                int age = 19;
                fichier << "Date de naissance : " << 24 << '/' << 3 << '/' << 1988 << std::endl;
